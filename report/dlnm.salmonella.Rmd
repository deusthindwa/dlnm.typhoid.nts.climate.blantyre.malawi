---
title: Nonlinear and delayed effects of climate on the risk of Salmonellosis in Blantyre, Malawi.
...
```{r SeasonAdjTS, results="hide", message=FALSE, warning=FALSE, fig.width=9, fig.height=4, fig.align='center'}
...
```{r predictRainNTS, results="hide", message=FALSE, warning=FALSE, fig.align='center', fig.height=5, fig.width=8}
...
```{r predictTempNTS, results="hide", message=FALSE, warning=FALSE, fig.align='center', fig.height=5, fig.width=8}
...
```{r predictRainTYP, results="hide", message=FALSE, warning=FALSE, fig.align='center', fig.height=5, fig.width=8}
...
```{r predictTempTYP, results="hide", message=FALSE, warning=FALSE, fig.align='center', fig.height=5, fig.width=8}
...
```{r validationCheck, results="hide", message=FALSE, warning=FALSE, fig.width=11, fig.height=8, fig.align='center'}
par(mfrow=c(3,4))
...
```{r DescrptiveStats, fig.align='center', message=FALSE, warning=FALSE}
